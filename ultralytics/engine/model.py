...
class Model(nn.Module):
    ...
    def __init__(self, model: Union[str, Path] = 'yolov8n.pt', task=None) -> None:
        ...
        inputs = (torch.zeros((1, 3, 320, 320)), )
        model_on_cuda = deepcopy(self.model).to('cuda')
        inputs_on_cuda = (inputs[0].to('cuda'), )
        macs_by_thop, params_by_thop = profile(model_on_cuda, inputs=inputs_on_cuda, verbose=False)
